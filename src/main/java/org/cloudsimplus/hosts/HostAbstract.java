...
public abstract class HostAbstract extends ExecDelayableAbstract implements Host {
    ...
    /** @see #getVmList() */
    protected final List<Vm> vmList = new ArrayList<>();
     ...
     */
    protected boolean activationChangeInProgress;
    @Getter
    protected double firstStartTime = -1;
    /** @see #getTotalUpTime() */
    protected double totalUpTime;
    @Getter @NonNull
    protected ResourceProvisioner ramProvisioner;
    @Getter @NonNull
    protected ResourceProvisioner bwProvisioner;
    @Getter @NonNull
    protected VmScheduler vmScheduler;
    @Getter @NonNull
    protected List<Pe> peList;
    @Getter @Setter
    protected boolean stateHistoryEnabled;
    @Getter
    protected int freePesNumber;
    @Getter
    protected int busyPesNumber;
    @Getter
    protected int workingPesNumber;
    @Getter
    protected int failedPesNumber;
    ...
    protected void notifyOnUpdateProcessingListeners(final double nextSimulationTime) {
     ...
     */
    protected HostSuitability allocateResourcesForVm(final Vm vm, final boolean inMigration) {
    ...
    protected void logAllocationError(
     ...
     * @see #setActive(boolean)
     */
    protected void notifyStartupOrShutdown(final boolean activate, final boolean wasActive) {
    ...
    protected void updateOnShutdownListeners() {
    ...
    protected void updateOnStartupListeners() {
    ...
    protected void checkSimulationIsRunningAndAttemptedToChangeHost(final String resourceName) {
        if (simulation.isRunning()) {
    ...
    protected void updatePeStatus(final Pe pe, final Pe.Status newStatus) {
     ...
     */
    protected void updatePeStatusCount(final Pe.Status status, final boolean isIncrement) {
    ...
    protected List<Pe> getFilteredPeList(final Predicate<Pe> status) {
    ...
    protected double getCpuMipsRequested() {
     ...
     */
    protected double addVmResourceUseToHistoryIfNotMigratingIn(final Vm vm, final double currentTime) {
     ...
     */
    protected void addStateHistoryEntry(
        final double time,
